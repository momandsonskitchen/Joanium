...
//
// Single source of truth for every SVG icon used across Chat, History,
// Projects, Templates, Skills, Personas, and Marketplace panels.
//
// Usage:
...
//   Returns a <span> with the SVG injected.
//   className defaults to 'chat-icon' when omitted.
//
// iconMarkup[name]
//   Raw SVG string — use when you need to set .innerHTML directly.
// ---------------------------------------------------------------------------
...
export const iconMarkup = {
  ...
  network: `
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
      ...
      <path d="M10 6.5h4" />
      <path d="M6.5 10v1.5A2.5 2.5 0 0 0 9 14" />
      <path d="M17.5 10v1.5A2.5 2.5 0 0 1 15 14" />
    </svg>
  `,
  ...
  fileJson: `
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
      ...
      <path d="M10 12a1 1 0 0 0-1 1v1a2 2 0 1 1-4 0v-1a1 1 0 0 0-1-1H3v4h1"/>
      <path d="M14 12a1 1 0 0 1 1 1v1a2 2 0 1 0 4 0v-1a1 1 0 0 1 1-1h1v4h-1"/>
    </svg>
  `,
  ...
  fileMd: `
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
      <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/>
      <polyline points="14 2 14 8 20 8"/>
      <path d="M7 15V9h2l1.5 3L12 9h2v6"/>
    </svg>
  `,
...
// ---------------------------------------------------------------------------
// createIcon — builds a <span> wrapper with the named SVG injected as HTML.
// className defaults to 'chat-icon' when omitted.
// ---------------------------------------------------------------------------
