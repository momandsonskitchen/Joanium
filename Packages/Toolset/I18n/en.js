const en = {
  errors: {
    ...
    invalidCoordinate:
      'Invalid coordinate. Latitude must be -90 to 90 and longitude must be -180 to 180.',
  ...
  tools: [
    {
      ...
      parameters: {
        ...
        precision: {
          type: 'number',
          required: false,
          description: 'Maximum decimal places, default 6.',
        },
      },
    },
    {
    ...
    },
    {
      name: 'calculate_date',
      description:
        'Perform date calculations: day of week, days between, add/subtract days, add months/years, countdowns, and date info.',
      category: 'datetime',
      parameters: {
        operation: {
          type: 'string',
          required: true,
          description:
            'day_of_week, days_between, add_days, subtract_days, add_months, add_years, countdown, or date_info.',
        },
        date: {
          type: 'string',
          required: false,
    ...
    },
    {
      ...
      parameters: {
        ...
        amount: {
          type: 'number',
          required: true,
          description: 'Business days to add. Negative values subtract.',
        },
      },
    },
    {
      ...
      parameters: {
        ...
        direction: {
          type: 'string',
          required: false,
          description: 'next or previous. Defaults to next.',
        },
      },
    },
    {
    ...
    },
    {
      name: 'get_season',
      description:
        'Get the meteorological season for a date in the northern or southern hemisphere.',
      category: 'datetime',
      parameters: {
        date: {
          type: 'string',
        ...
        hemisphere: {
          type: 'string',
          required: false,
          description: 'northern or southern. Defaults to northern.',
        },
      },
    },
    {
      name: 'get_month_info',
      description:
        'Show month details including start/end dates, weekday counts, and weekend totals.',
      category: 'datetime',
      parameters: {
        date: {
          type: 'string',
          required: false,
          description: 'Any date in the target month. Defaults to current month.',
        },
      },
    },
    {
    ...
    },
    {
      ...
      parameters: {
        date: {
          type: 'string',
          required: false,
          description: 'Any date in the week. Defaults to today.',
        },
        week_start: {
          type: 'string',
          required: false,
          description: 'sunday or monday. Defaults to sunday.',
        },
      },
    },
    {
    ...
    },
    {
      ...
      description:
        'Show the precise difference between two dates as years, months, days, weeks, hours, and minutes.',
      category: 'datetime',
      parameters: {
        date: { type: 'string', required: true, description: 'Start date in YYYY-MM-DD format.' },
        date2: { type: 'string', required: true, description: 'End date in YYYY-MM-DD format.' },
    ...
    },
    {
      ...
      parameters: {
        ...
        nth: {
          type: 'number',
          required: true,
          description: '1-5 for first-fifth, or -1 for last.',
        },
        weekday: { type: 'string', required: true, description: 'Weekday name.' },
      },
    },
    ...
    },
    {
      name: 'unix_converter',
      description:
        'Convert a date to a Unix timestamp or a Unix timestamp to a human-readable date.',
      category: 'datetime',
      parameters: {
        ...
        date: {
          type: 'string',
          required: false,
          description: 'Date in YYYY-MM-DD format for to_unix.',
        },
        unix_timestamp: {
          type: 'number',
          required: false,
          description: 'Unix timestamp in seconds or milliseconds for from_unix.',
        },
      },
    },
    {
      ...
      parameters: {
        ...
        time: {
          type: 'string',
          required: false,
          description: 'Target time in HH:MM. Defaults to 00:00.',
        },
        timezone: {
          type: 'string',
          required: false,
          description: 'Optional IANA timezone for the target time.',
        },
      },
    },
    {
    ...
    },
    {
      ...
      parameters: {
        url: {
          type: 'string',
          required: true,
          description: 'URL whose query parameters should be listed.',
        },
      },
    },
    {
      ...
      parameters: {
        base: {
          type: 'string',
          required: true,
          description: 'Base URL such as https://example.com.',
        },
    ...
    },
    {
      ...
      parameters: {
        ...
        include_subdomain: {
          type: 'boolean',
          required: false,
          description: 'Return full hostname when true.',
        },
      },
    },
    {
    ...
    },
    {
      ...
      parameters: {
        ...
        open_new_tab: {
          type: 'boolean',
          required: false,
          description: 'Add target and rel attributes.',
        },
      },
    },
    {
      ...
      parameters: {
        ...
        action: {
          type: 'string',
          required: false,
          description: 'encode or decode. Defaults to encode.',
        },
      },
    },
    {
    ...
    },
    {
      ...
      parameters: {
        ...
        precision: {
          type: 'number',
          required: false,
          description: 'Hash length 1-12. Defaults to 9.',
        },
      },
    },
    {
    ...
    },
    {
      name: 'get_map_url',
      description:
        'Generate shareable OpenStreetMap, Google Maps, and Apple Maps URLs for coordinates or a place query.',
      category: 'geo',
      parameters: {
    ...
    },
    {
      ...
      parameters: {
        ...
        algorithm: {
          type: 'string',
          required: false,
          description: 'sha256, sha1, sha384, or sha512.',
        },
      },
    },
    {
    ...
    },
    {
      ...
      description:
        'Convert text to lower, upper, title, sentence, camel, pascal, snake, kebab, or constant case.',
      category: 'utility',
      parameters: {
    ...
    },
    {
      ...
      parameters: {
        type: {
          type: 'string',
          required: false,
          description: 'password, passphrase, pin, or memorable.',
        },
        length: { type: 'number', required: false, description: 'Length or word count.' },
        count: {
          type: 'number',
          required: false,
          description: 'How many values to generate, max 10.',
        },
