const en = {
  ...
  tools: [
    ...
    },
    {
      ...
      description: 'Read the current page and list visible interactive elements with stable ids such as ow-1.',
      category: 'browser',
      parameters: {}
    },
    {
      ...
      category: 'browser',
      parameters: {
        target: { type: 'string', required: false, description: 'Stable id, CSS selector, label text, or empty for page body.' }
      }
    },
    {
      name: 'browser_click',
      description: 'Click a visible browser element by stable id, CSS selector, or visible label text.',
      category: 'browser',
      parameters: {
        target: { type: 'string', required: true, description: 'Stable id, CSS selector, or label text.' }
      }
    },
    {
      name: 'browser_type',
      ...
      parameters: {
        ...
        clear_first: { type: 'boolean', required: false, description: 'Clear existing value before typing. Defaults to true.' },
        press_enter: { type: 'boolean', required: false, description: 'Press Enter after typing.' }
      }
    },
    {
      name: 'browser_press_key',
      description: 'Send a keyboard key such as Enter, Tab, Escape, or ArrowDown to the live browser.',
      category: 'browser',
      parameters: {
    ...
    },
    {
      ...
      category: 'browser',
      parameters: {
        direction: { type: 'string', required: false, description: 'up, down, left, right, top, or bottom. Defaults to down.' },
        amount: { type: 'number', required: false, description: 'Pixels to scroll. Defaults to 600.' },
        target: { type: 'string', required: false, description: 'Optional stable id, selector, or label for a scrollable element.' }
      }
    },
    {
      name: 'browser_back',
