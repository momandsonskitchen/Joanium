const cloudflareStrings = {
  connector: {
    ...
    label: 'Cloudflare',
    description:
      'Zones, accounts, DNS records, cache purge, and user info through the Cloudflare API.',
    ...
    },
    {
      ...
      parameters: {
        limit: {
          type: 'number',
          required: false,
          description: 'Maximum accounts, default 20, max 50.',
        },
      },
    },
    {
      ...
      parameters: {
        ...
        limit: {
          type: 'number',
          required: false,
          description: 'Maximum zones, default 20, max 50.',
        },
      },
    },
    {
    ...
    },
    {
      ...
      parameters: {
        ...
        type: {
          type: 'string',
          required: false,
          description: 'Optional DNS type filter such as A, CNAME, TXT.',
        },
        limit: {
          type: 'number',
          required: false,
          description: 'Maximum records, default 20, max 100.',
        },
      },
    },
    {
      ...
      parameters: {
        ...
        ttl: {
          type: 'number',
          required: false,
          description: 'TTL seconds. Defaults to automatic.',
        },
      },
    },
    {
      ...
      parameters: {
        ...
        files: {
          type: 'string',
          required: false,
          description: 'Comma-separated URLs to purge. Empty purges everything.',
        },
      },
    },
  ],
