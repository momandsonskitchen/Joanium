  ...
  tools: [
    {
      ...
      description:
        'Get current weather for a city or place using the OpenWeather connector API key.',
      category: 'openweather',
      parameters: {
        location: {
          type: 'string',
          required: true,
          description: 'City, place, or "city,country code".',
        },
        units: {
          type: 'string',
          required: false,
          description: 'metric, imperial, or standard. Defaults to metric.',
        },
      },
    },
  ],
