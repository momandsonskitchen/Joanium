const stripeStrings = {
  connector: {
    id: 'stripe',
    label: 'Stripe',
    description: 'Account, balance, customers, charges, and payment intents through the Stripe API.',
  ...
  tools: [
    ...
    },
    {
      ...
      category: 'stripe',
      parameters: {
        limit: { type: 'number', required: false, description: 'Maximum customers, default 10, max 50.' }
      }
    },
    {
      ...
      category: 'stripe',
      parameters: {
        limit: { type: 'number', required: false, description: 'Maximum charges, default 10, max 50.' }
      }
    },
    {
    ...
    },
    {
      ...
      category: 'stripe',
      parameters: {
        limit: { type: 'number', required: false, description: 'Maximum payment intents, default 10, max 50.' }
      }
    }
  ]
};
