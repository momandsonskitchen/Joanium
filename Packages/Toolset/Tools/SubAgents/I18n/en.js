  ...
  tools: [
    {
      ...
      description: 'Delegate a medium or high complexity request into multiple focused sub-agents, then return their structured handoffs to the coordinator.',
      category: 'sub_agents',
      parameters: {
        tasks: {
          type: 'string',
          required: true,
          description: 'JSON array of task objects. Each task should include title and goal, and may include context or deliverable.'
        },
        coordination_goal: {
          type: 'string',
          required: false,
